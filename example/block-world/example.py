...
allow = True
state0.on = {'block-2':False,'block-3':'block-5','block-5':False,'block-1':False,'block-4':False,}
state0.down = {'block-2':False,'block-3':False,'block-5':'block-3','block-1':False,'block-4':False,}
state0.clear = {'block-2':True,'block-3':False,'block-5':True,'block-1':True,'block-4':True,}
state0.on_table = {'block-2':True,'block-3':True,'block-5':False,'block-1':True,'block-4':True,}

...
allow = False
state0.loc = {'truck1':('city1','loc2'),'truck2':('city2','loc2'),'truck3':('city3','loc1'),'truck4':('city4','loc1'),'truck5':('city5','loc2'),'plane1':('city4','loc1'),'pkg1':('city5','loc2'),'pkg2':('city1','loc1'),}

...
def generate_training_and_validating(training_path, validating_path, number_bottom, number_up, city, pkg_bottom, pkg_up, plane):
	...
	for index in range(number_bottom, number_up):
		city_num = city + 1
		pack_num = random.randint(pkg_bottom, pkg_up + 1)
		plane_num = plane + 1
		car_num = city_num
		order_str = "["
...
generate_training_and_validating("./training/", "./validating/", 1, 76, 5, 1, 4, 1)
generate_testing("./testing/", 1, 26, 5, 1, 4, 1)

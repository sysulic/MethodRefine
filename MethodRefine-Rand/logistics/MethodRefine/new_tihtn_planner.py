...
def instance():
    ...
    print('all collaborations of function and parameters are completed.' + "\n")
    return instances
        ...
        while not q.empty():
            ...
            for select_op in insertion:
                ...
                if check_ocuur(cur_state_copy, cur_all_tasks, orders):
                    ...
                    q.put((cur_state_copy, copy.deepcopy(cur_all_tasks), copy.deepcopy(orders), copy.deepcopy(copy_cur_plan)))

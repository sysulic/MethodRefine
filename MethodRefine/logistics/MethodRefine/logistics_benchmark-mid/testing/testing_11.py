...
allow = False
state0.loc = {'truck1':('city1','loc2'),'truck2':('city2','loc2'),'truck3':('city3','loc2'),'truck4':('city4','loc2'),'truck5':('city5','loc1'),'plane1':('city2','loc1'),'pkg1':('city3','loc1'),'pkg2':('city3','loc2'),}
...
def execute(completable):
	return new_tihtn_planner.pyhop(completable, allow, state0,[('delievery','pkg1',('city2','loc2')),('delievery','pkg2',('city4','loc2')),],[[0, 1],], 9)

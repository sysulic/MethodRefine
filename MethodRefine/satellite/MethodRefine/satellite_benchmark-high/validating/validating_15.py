...
state0.mode = {'inst-1-1':'mode-2','inst-2-4':'mode-2','inst-1-2':'mode-3','mode-1':['inst-3-1', 'inst-2-1', 'inst-2-2', 'inst-3-5'],'mode-2':['inst-1-1', 'inst-2-3', 'inst-2-4', 'inst-3-2'],'mode-3':['inst-3-3', 'inst-1-2', 'inst-3-4'],'inst-3-3':'mode-3','inst-3-2':'mode-2','inst-3-1':'mode-1','inst-3-4':'mode-3','inst-2-2':'mode-1','inst-2-3':'mode-2','inst-3-5':'mode-1','inst-2-1':'mode-1',}
state0.calib_target = {'inst-3-1':'direc-5','inst-1-1':'direc-4','inst-1-2':'direc-1','inst-3-3':'direc-4','inst-3-2':'direc-2','inst-2-4':'direc-3','inst-3-4':'direc-1','inst-2-2':'direc-3','inst-2-3':'direc-4','inst-3-5':'direc-2','inst-2-1':'direc-4',}
...
def execute(completable):
	return new_tihtn_planner.pyhop(completable, allow, state0,[('get_img','direc-4', 'mode-3'),('get_img','direc-4', 'mode-2'),('get_img','direc-1', 'mode-2'),('get_img','direc-2', 'mode-1'),], [[0, 1],[1, 2],[2, 3],],9)

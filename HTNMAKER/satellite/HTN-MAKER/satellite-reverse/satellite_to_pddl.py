...
satellite_training_path = "/home/cpl/AAAI2019/TIHTN/satellite_benchmark-low/training/"
satellite_testing_path = "/home/cpl/AAAI2019/TIHTN/satellite_benchmark-low/testing/"
...
for training_file in training_files:
    ...
    for task in tasks:
        direc = task[1]
        mode = task[2]
        fw.write("\t\t\t( have_image direc" + direc.split("-")[1] + " mode" + mode.split("-")[1] + " )\n")
    fw.write("\t\t)\n\t)\n)")

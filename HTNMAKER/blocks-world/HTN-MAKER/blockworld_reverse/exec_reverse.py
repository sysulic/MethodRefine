...
fw = open("result_reverse", "w")
for i in range(1, 76):
    print ("The " + str(i) + " iteration:\n")
    fw.write("The " + str(i) + " iteration:\n")
    ...
    # exec(training_str)
    res = os.popen("./htn-maker domain_strips.pddl tasks.pddl " + raw_prob_path + str(76 - i) + ".pddl " + solution_path + str(76 - i) + ".plan " + current_domain_path + "domain_partial_" + str(i - 1) + "_htn.pddl")
    ...
    for j in range(76, 101):
        ...
        while (True):
            ...
            print (str(mem) + "\n")
            if (mem > max_mem):
                fw.write("memory leakage occurs when solving instance " + str(j - 75) + "\n")
                child.kill()
        ...
        if (success_flag):
            ...
            if (len(res) > 1 and res[1].find("found") != -1):
                ...
                fw.write("instance " + str(j - 75) + ": solved")
            else:
                unsolved += 1
                print ("testing_" + str(j - 75) + " is unsolved\n")
                fw.write("instance " + str(j - 75) + ": unsolved")
        else:
            unsolved += 1
            print ("testing_" + str(j - 75) + " is unsolved\n")
            fw.write("instance " + str(j - 75) + ": unsolved")

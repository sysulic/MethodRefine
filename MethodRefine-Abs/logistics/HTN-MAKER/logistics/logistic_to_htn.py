...
logistic_training_path = "/home/cpl/AAAI2020/htn/root_prefer/logistics/MethodLearn/logistics_benchmark-high/training/"
logistic_testing_path = "/home/cpl/AAAI2020/htn/root_prefer/logistics/MethodLearn/logistics_benchmark-high/testing/"
...
for training_file in training_files:
    ...
    for task in tasks:
        ...
        x = task[2][0][-1]
        y = task[2][1][-1]
        fw.write("\t\t(DELIVER-PKG p" + pkg + " l" + x + y + ")\n")
    fw.write("\t)\n")
    fw.write(")")
    fw.close()
    i += 1

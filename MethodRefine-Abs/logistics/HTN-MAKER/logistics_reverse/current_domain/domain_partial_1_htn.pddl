( define ( domain logistics )
  ...
  ( :method DELIVER-PKG
    ...
    :precondition
    ( and ( TRUCK-AT ?auto_188 ?auto_192 ) ( IN-CITY ?auto_192 ?auto_191 ) ( IN-CITY ?auto_185 ?auto_191 ) ( not ( = ?auto_185 ?auto_192 ) ) ( TRUCK-AT ?auto_188 ?auto_194 ) ( AIRPORT ?auto_193 ) ( AIRPORT ?auto_194 ) ( not ( = ?auto_193 ?auto_194 ) ) ( OBJ-AT ?auto_184 ?auto_193 ) ( AIRPORT ?auto_196 ) ( AIRPLANE-AT ?auto_189 ?auto_196 ) ( not ( = ?auto_196 ?auto_193 ) ) )
    :subtasks
    ( ( !FLY-AIRPLANE ?auto_189 ?auto_196 ?auto_193 )
      ( DELIVER-PKG ?auto_184 ?auto_185 ) )
  )
  ...
  ( :method DELIVER-PKG
    ...
    :precondition
    ( and ( AIRPORT ?auto_1014 ) ( AIRPORT ?auto_1013 ) ( not ( = ?auto_1014 ?auto_1013 ) ) ( AIRPORT ?auto_1019 ) ( not ( = ?auto_1019 ?auto_1014 ) ) ( IN-CITY ?auto_1017 ?auto_1022 ) ( IN-CITY ?auto_1014 ?auto_1022 ) ( not ( = ?auto_1014 ?auto_1017 ) ) ( OBJ-AT ?auto_1012 ?auto_1017 ) ( TRUCK-AT ?auto_1023 ?auto_1020 ) ( IN-CITY ?auto_1020 ?auto_1024 ) ( IN-CITY ?auto_1017 ?auto_1024 ) ( not ( = ?auto_1017 ?auto_1020 ) ) ( AIRPORT ?auto_1015 ) ( not ( = ?auto_1015 ?auto_1019 ) ) ( AIRPORT ?auto_1026 ) ( AIRPLANE-AT ?auto_1016 ?auto_1026 ) ( not ( = ?auto_1026 ?auto_1015 ) ) )
    :subtasks
    ( ( !FLY-AIRPLANE ?auto_1016 ?auto_1026 ?auto_1015 )
      ( DELIVER-PKG ?auto_1012 ?auto_1013 ) )
  )
  ...
  ( :method DELIVER-PKG
    ...
    :precondition
    ( and ( IN-CITY ?auto_1210 ?auto_1213 ) ( IN-CITY ?auto_1209 ?auto_1213 ) ( not ( = ?auto_1209 ?auto_1210 ) ) ( TRUCK-AT ?auto_1217 ?auto_1218 ) ( IN-CITY ?auto_1218 ?auto_1214 ) ( IN-CITY ?auto_1210 ?auto_1214 ) ( not ( = ?auto_1210 ?auto_1218 ) ) ( AIRPORT ?auto_1219 ) ( AIRPORT ?auto_1210 ) ( not ( = ?auto_1219 ?auto_1210 ) ) ( OBJ-AT ?auto_1208 ?auto_1219 ) ( AIRPORT ?auto_1221 ) ( AIRPLANE-AT ?auto_1215 ?auto_1221 ) ( not ( = ?auto_1221 ?auto_1219 ) ) )
    :subtasks
    ( ( !FLY-AIRPLANE ?auto_1215 ?auto_1221 ?auto_1219 )
      ( DELIVER-PKG ?auto_1208 ?auto_1209 ) )
  )
